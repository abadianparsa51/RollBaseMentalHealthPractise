...
namespace Core.Layer.Migrations
{
    ...
    [Migration("20250815111841_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Model.Layer.Entity.Answer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Model.Layer.Entity.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Core.Model.Layer.Entity.DiagnosticRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Model.Layer.Entity.RuleCondition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Model.Layer.Entity.UserAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Model.Layer.Entity.RuleCondition", b =>
                {
                    b.HasOne("Core.Model.Layer.Entity.DiagnosticRule", "DiagnosticRule")
                        .WithMany("Conditions")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Core.Model.Layer.Entity.ApplicationUser", null)
                        .WithMany()
