...
//// دریافت تنظیمات PythonService از appsettings.json
...
//{
//    client.BaseAddress = new Uri(pythonConfig.BaseUrl); // آدرس Python API
//    client.DefaultRequestHeaders.Authorization =
//        new AuthenticationHeaderValue("Bearer", pythonConfig.Token); // توکن Python
//});

//// ثبت سرویس PythonIntegration
...
//    // ثبت Python Integration در Autofac هم
